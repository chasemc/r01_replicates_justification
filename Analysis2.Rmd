...
```{r setup, include=FALSE, cache=TRUE, fig.width=12}
...
```{r,  fig.width=12}
gridExtra::grid.arrange(plotter(data, "A019","A019"),
                        plotter(data, "A019","A046"),
                        grid::textGrob(""),
...
```{r,  fig.width=12}
gridExtra::grid.arrange(plotter(data, "172-6","A019"),
                        plotter(data, "172-6","A046"),
